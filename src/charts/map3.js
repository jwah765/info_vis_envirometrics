...
const stationGeometry = {
  1: { zone: "3_chassis_1", x: 10.1, y: 10.9, width: 5.9, height: 4 },
  2: { zone: "3_chassis_1", x: 16.1, y: 10.9, width: 5.9, height: 4 },
  3: { zone: "3_chassis_1", x: 22.05, y: 10.9, width: 5.9, height: 4 },
  4: { zone: "3_chassis_1", x: 28, y: 10.9, width: 5.9, height: 4 },
  5: { zone: "3_chassis_1", x: 34, y: 10.9, width: 5.9, height: 4 },
};
...
function drawHeatmap(data, metric) {
  ...
  const container = d3.select("#map-3");
  ...
  svg
    .append("image")
    .on("error", function () {
      console.error("Missing background image: 3_chassis_1.svg");
      d3.select(this).remove();
    })
    .attr("href", "3_chassis_1.svg")
    .attr("x", 0)
    .attr("y", 0)
    .attr("width", 1440)
    .attr("height", 974);
  ...
  svg
    ...
    .text(`Zone 3 (Chassis 1): ${metricFullName} Levels`);
  ...
  const labelGroups = svg
    ...
    .attr("transform", (d) => {
      ...
      const verticalOffset = 145; // Adjust this value to move the group up
