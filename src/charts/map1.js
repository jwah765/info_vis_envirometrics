...
const stationGeometry = {
  1: { zone: "1_trim_1", x: 13.3, y: 8.95, width: 4.6, height: 5.3 },
  2: { zone: "1_trim_1", x: 18, y: 8.95, width: 4.6, height: 5.3 },
  3: { zone: "1_trim_1", x: 22.7, y: 8.95, width: 4.6, height: 5.3 },
  4: { zone: "1_trim_1", x: 27.4, y: 8.95, width: 4.6, height: 5.3 },
  5: { zone: "1_trim_1", x: 32.1, y: 8.95, width: 4.6, height: 5.3 },
};
...
function drawHeatmap(data, metric) {
  const container = d3.select("#map-1");
  ...
  svg
    .append("image")
    .on("error", function () {
      console.error("Missing background image: 1_trim_1.svg");
      d3.select(this).remove();
    })
    .attr("href", "1_trim_1.svg")
    .attr("x", 0)
    .attr("y", 0)
    .attr("width", 1440)
    .attr("height", 974);
  ...
  svg
    ...
    .text(`Zone 1 (Trim 1): ${metricFullName} Levels`);
