...
const stationGeometry = {
  1: { zone: "2_trim_2", x: 14.25, y: 8.95, width: 5.3, height: 5.3 },
  2: { zone: "2_trim_2", x: 19.65, y: 8.95, width: 5.3, height: 5.3 },
  3: { zone: "2_trim_2", x: 25.05, y: 8.95, width: 5.3, height: 5.3 },
  4: { zone: "2_trim_2", x: 30.45, y: 8.95, width: 5.3, height: 5.3 },
};
...
function drawHeatmap(data, metric) {
  ...
  const container = d3.select("#map-2");
  ...
  svg
    .append("image")
    .on("error", function () {
      console.error("Missing background image: 2_trim_2.svg");
      d3.select(this).remove();
    })
    .attr("href", "2_trim_2.svg")
    .attr("x", 0)
    .attr("y", 0)
    .attr("width", 1440)
    .attr("height", 974);
  ...
  svg
    ...
    .text(`Zone 2 (Trim 2): ${metricFullName} Levels`);
